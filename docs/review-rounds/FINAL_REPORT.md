...
> ⚠️ **بایگانی‌شده و نامعتبر (بازبینی ۲۰۲۶-۰۹-۰۵).** این «۱۰۰۰/۱۰۰۰ ✅» را مبنا
> نگذارید: پس از این گزارش، چند نقص واقعی از ریشه پیدا و رفع شد — شمارش
> `jobId` که آمار صفحهٔ نتیجه را به کار قبلی قاتی می‌کرد، بی‌صدا رد شدن
> «حذف فایل اصلی» به‌خاطر نداشتن grant نوشتن MediaStore، بسته‌شدن کل اسکن پوشه
> با پر شدن سهمیهٔ یک نوع رسانه، و گم شدن تپ نوتیفیکیشن در استارت سرد.
> فهرست بازها: `docs/ROADMAP_FIXES.md` و `docs/KNOWN_ISSUES.md`.

## نمره نهایی: ۱۰۰۰ / ۱۰۰۰ ✅ (بایگانی‌شده — بالا را ببینید)
